...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    {...props}
  >
    <ScrollAreaPrimitive.ScrollAreaThumb className="relative flex-1 rounded-full bg-on-surface-variant/40 hover:bg-on-surface-variant/60 transition-colors duration-200" />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
))
