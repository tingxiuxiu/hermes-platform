...
class AttachmentItem(BaseModel):
    ...
    url: str = Field(..., description="附件访问 URL")
    mime_type: Optional[str] = Field(None, description="附件 MIME 类型")
...
class CreateExecution(BaseModel):
    ...
    job_name: str = Field(..., max_length=255, description="Jenkins 任务名称")
    job_url: str = Field(..., max_length=255, description="Jenkins 任务地址")
...
# ==============================================================================
class QueryPipelineList(BaseModel):
    """自动化任务列表查询参数"""
...
# ==============================================================================
class CreateExecutionItem(BaseModel):
...
class UpdateExecutionItem(BaseModel):
    """上报一次用例执行结束"""
...
class QueryExecutionItemList(BaseModel):
...
# 5. 跨执行历史查询模型
# ==============================================================================
class QueryExecutionItemHistory(BaseModel):
