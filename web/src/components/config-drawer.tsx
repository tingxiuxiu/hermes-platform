...
import { IconThemeAppleLight } from '@/assets/custom/icon-theme-apple-light'
import { IconThemeAppleDark } from '@/assets/custom/icon-theme-apple-dark'
      ...
      >
        {[
          ...
          },
          {
            value: 'apple-light',
            label: 'Apple Light',
            icon: IconThemeAppleLight,
          },
          {
            value: 'apple-dark',
            label: 'Apple Dark',
            icon: IconThemeAppleDark,
          },
        ].map((item) => (
